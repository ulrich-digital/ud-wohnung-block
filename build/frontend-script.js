...
/* harmony import */ var _css_frontend_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../css/frontend.scss */ "./src/css/frontend.scss");
...
function initWohnungSlider() {
  const slider = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".wp-block-ud-wohnung-block .wohnung-gallery");
  if (slider.length) {
    slider.slick({
      arrows: true,
      dots: false,
...
document.addEventListener("DOMContentLoaded", () => {
  const containers = document.querySelectorAll(".is-style-wohnung-block-masonry");
  const grids = [];
  containers.forEach(container => {
    ...
    const iso = new (isotope_layout__WEBPACK_IMPORTED_MODULE_3___default())(container, {
  ...
  document.querySelectorAll(".ud-accordion__title").forEach(toggle => {
    toggle.addEventListener("click", () => {
      grids.forEach(({
        ...
        [0, 100, 200, 500].forEach(delay => setTimeout(() => iso.layout(), delay));
      });
    });
  });
